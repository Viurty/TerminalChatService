...
const file_chatpb_proto_rawDesc = "" +
	...
	"\vChatService\x12.\n" +
	"\x04Chat\x12\x10.api.ChatMessage\x1a\x10.api.ChatMessage(\x010\x01\x121\n" +
	"\bAuthUser\x12\x11.api.LoginRequest\x1a\x12.api.LoginResponseB\x17Z\x15example.com/myapp/apib\x06proto3"
...
var file_chatpb_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_chatpb_proto_depIdxs = []int32{
	0, // 0: api.ChatService.Chat:input_type -> api.ChatMessage
	1, // 1: api.ChatService.AuthUser:input_type -> api.LoginRequest
	0, // 2: api.ChatService.Chat:output_type -> api.ChatMessage
	2, // 3: api.ChatService.AuthUser:output_type -> api.LoginResponse
